...
async function rewriteProjectReadme(
  ...
  try {
    ...
    const generated = [
      ...
      '- Run `pnpm ops:retention` to prune old `ops/snapshots/`, `ops/evidence/`, `ops/index/`, `ops/reports/`, `ops/bundles/`, `ops/doctors/`, `ops/handoffs/`, `ops/attestations/`, `ops/ready/`, `ops/gates/`, `ops/releasepacks/`, `ops/exports/`, `ops/restores/`, `ops/recoveries/`, `ops/rollbacks/`, `ops/incidents/`, `ops/escalations/`, `ops/continuity/`, `ops/resilience/`, `ops/runbooks/`, `ops/integrity/`, `ops/compliance/`, `ops/certifications/`, `ops/assurances/`, `ops/governance/`, `ops/oversight/`, and `ops/control/` directories before or after repeated production checks',
...
function getOpsControlScript(): string {
  return [
    ...
    '',
    'const copied = {',
    '  oversight: copySurface(oversight, \'oversight\', [\'ops-oversight.json\', \'ops-oversight.md\', \'ops-oversight.tgz\']),',
    '  governance: copySurface(governance, \'governance\', [\'ops-govern.json\', \'ops-govern.md\', \'ops-govern.tgz\']),',
    '  assurance: copySurface(assurance, \'assurance\', [\'ops-assure.json\', \'ops-assure.md\', \'ops-assure.tgz\']),',
    '  index: copySurface(index, \'index\', [\'ops-index.json\', \'ops-index.md\']),',
    '  oversightPacket: [],',
    ...
    'if (copyDirIfExists(oversightPacketDir, path.join(packetDir, \'oversight\', \'packet\'))) {',
...
function getValidateWorkflow(): string {
  return [
    ...
    '        run: pnpm build',
    '',
    '      - name: Operations control handoff',
    '        run: pnpm ops:control -- --label validate --skip-retention',
    '',
...
function getReleaseWorkflow(): string {
  return [
    ...
    '',
    '      - name: Operations control handoff',
    '        run: pnpm ops:control -- --label release-${{ matrix.platform }} --skip-retention --require-release-output',
    '',
    '      - name: Upload operations snapshots',
    '        if: always()',
    '        uses: actions/upload-artifact@v4',
...
function getReleasePlaybook(projectName: string, metadata: ScaffoldMetadata): string {
  ...
  return [
    ...
    'pnpm production:check',
    'pnpm package',
    'pnpm ops:control -- --label release-smoke --require-release-output',
    '```',
    '',
    ...
    '```',
    '',
    'Use `pnpm ops:oversight` when you want the final production oversight packet under `ops/oversight/` and `pnpm ops:control` when you want one last operator-facing control packet under `ops/control/` before close-out.',
    '',
...
function getProductionReadinessGuide(projectName: string, metadata: ScaffoldMetadata): string {
  ...
  return [
    ...
    'pnpm production:check',
    'pnpm package',
    'pnpm ops:control -- --label github-readiness --require-release-output',
    '```',
    '',
    ...
    'pnpm package:s3',
    'pnpm ops:control -- --label s3-readiness --require-release-output',
    '```',
    '',
    ...
    'pnpm package',
    'pnpm ops:control -- --label full-audit --require-release-output',
    '```',
    '',
