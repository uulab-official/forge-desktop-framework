...
async function rewriteProjectReadme(
  ...
  try {
    ...
    const generated = [
      ...
      '- Run `pnpm ops:index` when you want one inventory view of the current `ops/snapshots/`, `ops/evidence/`, `ops/reports/`, `ops/bundles/`, `ops/doctors/`, `ops/handoffs/`, `ops/attestations/`, `ops/ready/`, `ops/gates/`, `ops/releasepacks/`, and `ops/exports/` directories',
      ...
      '- Run `pnpm ops:retention` to prune old `ops/snapshots/`, `ops/evidence/`, `ops/index/`, `ops/reports/`, `ops/bundles/`, `ops/doctors/`, `ops/handoffs/`, `ops/attestations/`, `ops/ready/`, `ops/gates/`, `ops/releasepacks/`, and `ops/exports/` directories before or after repeated production checks',
...
function getProductionReadinessScript(): string {
  return [
    ...
    'done',
    '',
    'echo "=== Operations export (${snapshot_label}) ==="',
    'export_args=(-- --label "$snapshot_label" --skip-retention)',
...
function getOpsIndexScript(): string {
  return [
    ...
    '  counts: { snapshots: snapshots.length, evidence: evidence.length, reports: reports.length, bundles: bundles.length, doctors: doctors.length, handoffs: handoffs.length, attestations: attestations.length, ready: readys.length, gates: gates.length, releasePacks: releasePacks.length, exports: exports.length },',
    '  latest: {',
...
function getValidateWorkflow(): string {
  return [
    ...
    '        run: pnpm ops:export -- --label validate --skip-retention',
    '',
...
function getReleaseWorkflow(): string {
  return [
    ...
    '',
    '      - name: Operations export',
    '        run: pnpm ops:export -- --label release-${{ matrix.platform }} --skip-retention --require-release-output',
    '',
    '      - name: Upload operations snapshots',
    '        if: always()',
    '        uses: actions/upload-artifact@v4',
...
function getReleasePlaybook(projectName: string, metadata: ScaffoldMetadata): string {
  ...
  return [
    ...
    'pnpm production:check',
    'pnpm package',
    'pnpm ops:export -- --label release-smoke --require-release-output',
    '```',
    '',
...
function getProductionReadinessGuide(projectName: string, metadata: ScaffoldMetadata): string {
  ...
  return [
    ...
    'pnpm production:check',
    'pnpm package',
    'pnpm ops:export -- --label github-readiness --require-release-output',
    '```',
    '',
    ...
    'pnpm package:s3',
    'pnpm ops:export -- --label s3-readiness --require-release-output',
    '```',
    '',
    ...
    'pnpm package',
    'pnpm ops:export -- --label full-audit --require-release-output',
    '```',
    '',
    ...
    '',
    '```bash',
    'pnpm ops:export -- --label release-export --require-release-output',
    '```',
    '',
    'Use `pnpm ops:export` when you want one final portable Markdown, JSON, and tarball release export under `ops/exports/` after the gate verdict, release pack, and packaged release output are all in place.',
    '',
    '## What Gets Checked',
    '',
