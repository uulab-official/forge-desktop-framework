...
- generated apps now also get `pnpm security:check`, `pnpm ops:check`, `pnpm ops:snapshot`, `pnpm ops:evidence`, `pnpm ops:report`, `pnpm ops:bundle`, `pnpm ops:index`, `pnpm ops:doctor`, `pnpm ops:handoff`, `pnpm ops:attest`, `pnpm ops:ready`, `pnpm ops:gate`, `pnpm ops:releasepack`, `pnpm ops:export`, `pnpm ops:restore`, `pnpm ops:recover`, `pnpm ops:rollback`, `pnpm ops:incident`, `pnpm ops:escalate`, `pnpm ops:continuity`, `pnpm ops:resilience`, `pnpm ops:runbook`, and `pnpm production:check*` commands plus `docs/production-readiness.md` so production-grade validation can be rerun from one entry point
