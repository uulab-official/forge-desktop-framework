...
- tagged release metadata now also includes `one-point-zero-major-release-constitution.md/json`, which turns that canon artifact plus the prepared `v1.0.0` checklist into the final immutable constitution surface for the first major ship
...
- maintainers can now also validate the final 1.0 major-release constitution surface with `pnpm release:major:constitution:test`
