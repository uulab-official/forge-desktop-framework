...
- tagged release metadata now also includes `one-point-zero-major-release-constitution.md/json`, `one-point-zero-major-release-covenant.md/json`, `one-point-zero-major-release-compact.md/json`, and `one-point-zero-major-release-capsule.md/json`, which turn that canon artifact plus the prepared `v1.0.0` checklist into the final immutable constitution, covenant, compact, and capsule surfaces for the first major ship
...
- maintainers can now also validate the final 1.0 major-release constitution, covenant, compact, and capsule surfaces with `pnpm release:major:constitution:test`, `pnpm release:major:covenant:test`, `pnpm release:major:compact:test`, and `pnpm release:major:capsule:test`
