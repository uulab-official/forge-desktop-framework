...
export function FeatureStudio() {
  ...
  const [fileDialogDraft, setFileDialogDraft] = useState('scaffoldtestfiledialogs79141-document.txt');
  const featureNames = ["file-dialogs"];
  ...
  return (
    <div className="border-t border-slate-800 bg-slate-950/80 px-4 py-4">
      <div className="flex flex-wrap items-center gap-2">
        <p className="text-[11px] uppercase tracking-[0.24em] text-slate-500">Scaffold Test File Dialogs 79141 Feature Packs</p>
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4 md:col-span-2">
          ...
          <div className="mt-3 space-y-3">
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              <DiagnosticRow label="Suggested Name" value={fileDialogState?.suggestedName ?? 'scaffoldtestfiledialogs79141-document.txt'} />
