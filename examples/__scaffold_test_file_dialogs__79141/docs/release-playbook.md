# Scaffold Test File Dialogs 79141 Release Playbook

## 1. Set Metadata

- Verify `electron-builder.yml` still matches your release identity: `Scaffold Test File Dialogs 79141` / `com.forge.scaffoldtestfiledialogs79141`.
...
- Default GitHub target for publishing is `your-github-org-or-user/scaffoldtestfiledialogs79141`. Override with `GH_OWNER` and `GH_REPO` if needed.
...
- GitHub Releases works out of the box for `your-github-org-or-user/scaffoldtestfiledialogs79141` unless you override `GH_OWNER` and `GH_REPO`.
