# Scaffold Test Auto Launch 79141 Release Playbook

## 1. Set Metadata

- Verify `electron-builder.yml` still matches your release identity: `Scaffold Test Auto Launch 79141` / `com.forge.scaffoldtestautolaunch79141`.
...
- Default GitHub target for publishing is `your-github-org-or-user/scaffoldtestautolaunch79141`. Override with `GH_OWNER` and `GH_REPO` if needed.
...
- GitHub Releases works out of the box for `your-github-org-or-user/scaffoldtestautolaunch79141` unless you override `GH_OWNER` and `GH_REPO`.
