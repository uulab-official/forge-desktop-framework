...
export function FeatureStudio() {
  ...
  const [globalShortcutState, setGlobalShortcutState] = useState<GlobalShortcutState | null>(null);
  const featureNames = ["global-shortcut"];
  ...
  return (
    <div className="border-t border-slate-800 bg-slate-950/80 px-4 py-4">
      <div className="flex flex-wrap items-center gap-2">
        <p className="text-[11px] uppercase tracking-[0.24em] text-slate-500">Scaffold Test Global Shortcut 79141 Feature Packs</p>
