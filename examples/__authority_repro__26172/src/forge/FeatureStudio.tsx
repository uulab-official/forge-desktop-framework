...
export function FeatureStudio() {
  ...
  const [notificationDraft, setNotificationDraft] = useState({ title: 'Forge Ready', body: 'Authority Repro 26172 is ready for customer testing.' });
  ...
  const [fileAssociationDraft, setFileAssociationDraft] = useState('sample.authorityrepro26172doc');
  const [fileDialogState, setFileDialogState] = useState<FileDialogState | null>(null);
  const [fileDialogDraft, setFileDialogDraft] = useState('authorityrepro26172-document.txt');
  const [recentFilesState, setRecentFilesState] = useState<RecentFilesState | null>(null);
  const [recentFileDraft, setRecentFileDraft] = useState('authorityrepro26172-document.txt');
  ...
  return (
    <div className="border-t border-slate-800 bg-slate-950/80 px-4 py-4">
      <div className="flex flex-wrap items-center gap-2">
        <p className="text-[11px] uppercase tracking-[0.24em] text-slate-500">Authority Repro 26172 Feature Packs</p>
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-2">
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4 ">
          ...
          <div className="mt-3 space-y-3">
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              <DiagnosticRow label="Extension" value={fileAssociationState?.extension ?? 'authorityrepro26172doc'} />
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4 ">
          ...
          <div className="mt-3 space-y-3">
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              <DiagnosticRow label="Suggested Name" value={fileDialogState?.suggestedName ?? 'authorityrepro26172-document.txt'} />
