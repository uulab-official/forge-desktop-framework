# Authority Repro 26172 Release Playbook

## 1. Set Metadata

- Verify `electron-builder.yml` still matches your release identity: `Authority Repro 26172` / `com.forge.authorityrepro26172`.
...
- Default GitHub target for publishing is `your-github-org-or-user/authorityrepro26172`. Override with `GH_OWNER` and `GH_REPO` if needed.
...
- GitHub Releases works out of the box for `your-github-org-or-user/authorityrepro26172` unless you override `GH_OWNER` and `GH_REPO`.
