...
export function FeatureStudio() {
  ...
  const [deepLinkState, setDeepLinkState] = useState<DeepLinkState | null>(null);
  const [deepLinkDraft, setDeepLinkDraft] = useState('scaffoldtestdeeplink79141://open?screen=home');
  const featureNames = ["deep-link"];
  ...
  return (
    <div className="border-t border-slate-800 bg-slate-950/80 px-4 py-4">
      <div className="flex flex-wrap items-center gap-2">
        <p className="text-[11px] uppercase tracking-[0.24em] text-slate-500">Scaffold Test Deep Link 79141 Feature Packs</p>
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4 md:col-span-2">
          ...
          <div className="mt-3 space-y-3">
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              <DiagnosticRow label="Scheme" value={deepLinkState?.scheme ?? 'scaffoldtestdeeplink79141'} />
