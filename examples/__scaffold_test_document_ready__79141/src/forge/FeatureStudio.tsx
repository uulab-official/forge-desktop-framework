...
export function FeatureStudio() {
  ...
  const [fileAssociationDraft, setFileAssociationDraft] = useState('sample.scaffoldtestdocumentready79141doc');
  const [fileDialogState, setFileDialogState] = useState<FileDialogState | null>(null);
  const [fileDialogDraft, setFileDialogDraft] = useState('scaffoldtestdocumentready79141-document.txt');
  const [recentFilesState, setRecentFilesState] = useState<RecentFilesState | null>(null);
  const [recentFileDraft, setRecentFileDraft] = useState('scaffoldtestdocumentready79141-document.txt');
  const featureNames = ["file-association","file-dialogs","recent-files","windowing","menu-bar"];
  ...
  return (
    <div className="border-t border-slate-800 bg-slate-950/80 px-4 py-4">
      <div className="flex flex-wrap items-center gap-2">
        <p className="text-[11px] uppercase tracking-[0.24em] text-slate-500">Scaffold Test Document Ready 79141 Feature Packs</p>
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-2">
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4 ">
          ...
          <div className="mt-3 space-y-3">
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              <DiagnosticRow label="Extension" value={fileAssociationState?.extension ?? 'scaffoldtestdocumentready79141doc'} />
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4 ">
          ...
          <div className="mt-3 space-y-3">
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              <DiagnosticRow label="Suggested Name" value={fileDialogState?.suggestedName ?? 'scaffoldtestdocumentready79141-document.txt'} />
