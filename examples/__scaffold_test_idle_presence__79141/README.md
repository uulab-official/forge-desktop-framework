# __scaffold_test_idle_presence__79141

Bare minimum app — one input, one Python action

Generated with `create-forge-desktop@0.1.57` using the `minimal` template.

## Release Identity

- Product name: `Scaffold Test Idle Presence 79141`
- App ID: `com.forge.scaffoldtestidlepresence79141`
