...
Tagged release metadata now also emits `one-point-zero-major-release-constitution.md/json`, `one-point-zero-major-release-covenant.md/json`, `one-point-zero-major-release-compact.md/json`, `one-point-zero-major-release-capsule.md/json`, and `one-point-zero-major-release-ledger.md/json`, which turn that canon artifact and prepared `v1.0.0` checklist into the final immutable constitution, covenant, compact, capsule, and ledger surfaces before the first major ship.
...
The same `1.0` stack now also emits `one-point-zero-major-release-constitution.md/json`, `one-point-zero-major-release-covenant.md/json`, `one-point-zero-major-release-compact.md/json`, `one-point-zero-major-release-capsule.md/json`, and `one-point-zero-major-release-ledger.md/json` so the final immutable major-release constitution, covenant, compact, capsule, and ledger surfaces survive as tagged release artifacts too.
