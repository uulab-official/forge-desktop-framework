...
- Treat tagged release jobs as auditable surfaces too: signing-readiness, summary, and publish-audit artifacts should stay aligned with the actual installer and manifest outputs.
