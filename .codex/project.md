...
- The final `one-point-zero-major-release-constitution`, `one-point-zero-major-release-covenant`, `one-point-zero-major-release-compact`, `one-point-zero-major-release-capsule`, `one-point-zero-major-release-ledger`, `one-point-zero-major-release-archive`, `one-point-zero-major-release-vault`, `one-point-zero-major-release-registry`, `one-point-zero-major-release-directory`, `one-point-zero-major-release-manifest`, `one-point-zero-major-release-dossier`, `one-point-zero-major-release-folio`, `one-point-zero-major-release-portfolio`, `one-point-zero-major-release-compendium`, `one-point-zero-major-release-anthology`, `one-point-zero-major-release-omnibus`, `one-point-zero-major-release-digest`, `one-point-zero-major-release-synopsis`, `one-point-zero-major-release-brief`, and `one-point-zero-major-release-abstract` artifacts should stay in step with the canon artifact and prepared `v1.0.0` checklist so the first `1.0.0` immutable constitution, covenant, compact, capsule, ledger, archive, vault, registry, directory, manifest, dossier, folio, portfolio, compendium, anthology, omnibus, digest, synopsis, brief, and abstract remain reproducible.
