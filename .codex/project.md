...
- The final `one-point-zero-major-release-constitution`, `one-point-zero-major-release-covenant`, `one-point-zero-major-release-compact`, `one-point-zero-major-release-capsule`, `one-point-zero-major-release-ledger`, `one-point-zero-major-release-archive`, `one-point-zero-major-release-vault`, and `one-point-zero-major-release-registry` artifacts should stay in step with the canon artifact and prepared `v1.0.0` checklist so the first `1.0.0` immutable constitution, covenant, compact, capsule, ledger, archive, vault, and registry remain reproducible.
