...
- The final `one-point-zero-major-release-constitution` artifact should stay in step with the canon artifact and prepared `v1.0.0` checklist so the first `1.0.0` immutable constitution remains reproducible.
