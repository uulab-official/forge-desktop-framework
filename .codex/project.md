...
- Treat tagged release jobs as auditable surfaces too: signing-readiness, per-platform summaries, publish-audit artifacts, the final matrix summary, and release provenance should stay aligned with the actual installer and manifest outputs.
