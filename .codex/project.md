...
- The final `one-point-zero-major-release-activation` artifact should stay in step with the go-live artifact and prepared `v1.0.0` checklist so the first `1.0.0` execution confirmation surface remains reproducible.
