...
echo "Running One Point Zero major release execution smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-execution.sh
echo ""

echo "Running One Point Zero major release attestation smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-attestation.sh
echo ""

echo "Running One Point Zero major release seal smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-seal.sh
echo ""

echo "Running One Point Zero major release charter smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-charter.sh
echo ""

echo "Running One Point Zero major release canon smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-canon.sh
echo ""

echo "Running One Point Zero major release constitution smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-constitution.sh
...
echo "Running One Point Zero major release capsule smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-capsule.sh
echo ""

echo "Running One Point Zero major release ledger smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-ledger.sh
echo ""

echo "Running One Point Zero major release archive smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-archive.sh
echo ""

echo "Running One Point Zero major release vault smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-vault.sh
echo ""

echo "Running One Point Zero major release registry smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-registry.sh
echo ""

echo "Running One Point Zero major release directory smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-directory.sh
echo ""

echo "Running One Point Zero major release manifest smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-manifest.sh
echo ""

echo "Running One Point Zero major release dossier smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-dossier.sh
echo ""

echo "Running One Point Zero major release folio smoke test before version bump..."
...
echo "Running One Point Zero major release compendium smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-compendium.sh
echo ""

echo "Running One Point Zero major release anthology smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-anthology.sh
echo ""

echo "Running One Point Zero major release omnibus smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-omnibus.sh
echo ""

echo "Running One Point Zero major release digest smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-digest.sh
echo ""

echo "Running One Point Zero major release synopsis smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-synopsis.sh
echo ""

echo "Running One Point Zero major release brief smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-brief.sh
echo ""

echo "Running One Point Zero major release abstract smoke test before version bump..."
bash scripts/test-one-point-zero-major-release-abstract.sh
echo ""
