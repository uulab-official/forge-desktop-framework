...
- Keep the final `one-point-zero-major-release-attestation.md/json` summary aligned with the execution artifact and prepared `v1.0.0` checklist so the first `1.0.0` immutable ship record stays reproducible.
