...
- Prefer the standardized release inventory bundle as the archived rollback input shape; keep bundle contents aligned with the drill helpers and tagged release artifacts.
