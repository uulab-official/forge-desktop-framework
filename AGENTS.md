...
- Keep the final `one-point-zero-major-release-go-live.md/json` summary aligned with the rehearsal artifact and prepared `v1.0.0` checklist so the first `1.0.0` execution surface stays reproducible.
