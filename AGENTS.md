...
- Keep `.github/workflows/release.yml` aligned too: packaged release jobs should emit human-readable inventories and fail when platform-specific installers or `latest*.yml` manifests are missing.
